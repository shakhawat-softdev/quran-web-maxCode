...
import { Menu, BookMarked, Search } from 'lucide-react';
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="font-['Poppins'] font-semibold text-foreground">Quran App</h1>
                  <p className="text-sm text-muted-foreground">Read & Reflect</p>
                </div>
              </div>
            </div>
            <Link
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {filteredSurahs.length === 0 && (
          ...
          >
            ...
            <h3 className="font-['Poppins'] text-foreground mb-2">No surahs found</h3>
